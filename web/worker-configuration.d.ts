/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: adc49fb002bd2b1f199afdface5f75ef)
// Runtime types generated with workerd@1.20260526.1 2026-01-01 nodejs_compat
interface __BaseEnv_Env {
	API_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	PUBLIC_GOOGLE_ANALYTICS_ID: string;
	PUBLIC_BETTER_STACK_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_GOOGLE_ANALYTICS_ID" | "PUBLIC_BETTER_STACK_TOKEN">> {}
}
