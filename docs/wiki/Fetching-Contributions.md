...
The Flutter app has its own implementation ([`infrastructure/github/contribution_repository_impl.dart`](https://github.com/fbuireu/contribKit/blob/main/app/lib/infrastructure/github/contribution_repository_impl.dart)) following the same idea.
