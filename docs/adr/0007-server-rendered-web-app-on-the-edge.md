...
- The domain layer stays pure precisely so this is survivable: nothing under `web/src/domain` knows the platform exists — see [3](0003-layered-domain-architecture-in-both-clients.md).
