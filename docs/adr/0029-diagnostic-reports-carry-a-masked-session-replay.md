...
- Where this bites: [`app/lib/infrastructure/CLAUDE.md`](../../app/lib/infrastructure/CLAUDE.md), [`app/lib/ui/CLAUDE.md`](../../app/lib/ui/CLAUDE.md), the app section of [`web/src/pages/privacy.astro`](../../web/src/pages/privacy.astro) and the *Telemetry* bullet in the root [`CLAUDE.md`](../../CLAUDE.md).
