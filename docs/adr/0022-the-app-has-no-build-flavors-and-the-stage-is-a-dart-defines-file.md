...
- Where it bites: the **Gotchas** in [`AGENTS.md`](../../AGENTS.md), the app section of [`ARCHITECTURE.md`](../../ARCHITECTURE.md), the app setup in [`CONTRIBUTING.md`](../../.github/CONTRIBUTING.md), the environment mapping in [`README.md`](../../README.md), and [`docs/wiki/CI-CD.md`](../wiki/CI-CD.md).
