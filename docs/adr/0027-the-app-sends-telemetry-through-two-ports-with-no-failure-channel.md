...
Accepted. Sits beside [4](0004-typed-failures-instead-of-thrown-exceptions.md), whose rule it deliberately departs from, and [25](0025-how-much-ddd-and-where-it-stops.md), whose three questions decided what got modelled. Extended by [29](0029-diagnostic-reports-carry-a-masked-session-replay.md), which adds a masked replay to a foreground report without widening what one may carry.
