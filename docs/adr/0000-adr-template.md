...
What was decided, in the present tense, as a rule the codebase follows. Name the alternative that was rejected and why, since that is what stops it being re-proposed. Point at the code with symbol names rather than line numbers — a `file.ts:123` citation rots the moment anything above it moves.
