...
- **The Exports change size in 2028 and 2056.** They already asked the geometry service for their dimensions and passed the calendar's own week count, so they follow automatically; the format tile did not and now does. A PNG for 2028 is one column wider than one for 2029.
