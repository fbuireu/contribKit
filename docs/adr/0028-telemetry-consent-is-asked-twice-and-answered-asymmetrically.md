...
- Where this bites: the app section of [`web/src/pages/privacy.astro`](../../web/src/pages/privacy.astro), [`app/lib/ui/CLAUDE.md`](../../app/lib/ui/CLAUDE.md), and the *What the app sends off the device* row of the root [`CLAUDE.md`](../../CLAUDE.md), which points back at the table above.
