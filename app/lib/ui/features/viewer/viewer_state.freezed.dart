...
mixin _$ViewerState {
 ...
 Username? get username; ContributionCalendar? get calendar; ContributionStats? get stats; bool get fromCache; bool get isLoadingCalendar; Year? get year; bool get isLoadingSettings; Palette? get palette; CellShape get cellShape; CellSize get cellSize; BackgroundPreset get backgroundPreset; Failure? get error;
...
@override
int get hashCode => Object.hash(runtimeType,username,calendar,stats,fromCache,isLoadingCalendar,year,isLoadingSettings,palette,cellShape,cellSize,backgroundPreset,error);

@override
String toString() {
  return 'ViewerState(username: $username, calendar: $calendar, stats: $stats, fromCache: $fromCache, isLoadingCalendar: $isLoadingCalendar, year: $year, isLoadingSettings: $isLoadingSettings, palette: $palette, cellShape: $cellShape, cellSize: $cellSize, backgroundPreset: $backgroundPreset, error: $error)';
}
...
@useResult
$Res call({
 Username? username, ContributionCalendar? calendar, ContributionStats? stats, bool fromCache, bool isLoadingCalendar, Year? year, bool isLoadingSettings, Palette? palette, CellShape cellShape, CellSize cellSize, BackgroundPreset backgroundPreset, Failure? error
});
...
/// Create a copy of ViewerState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? username = freezed,Object? calendar = freezed,Object? stats = freezed,Object? fromCache = null,Object? isLoadingCalendar = null,Object? year = freezed,Object? isLoadingSettings = null,Object? palette = freezed,Object? cellShape = null,Object? cellSize = null,Object? backgroundPreset = null,Object? error = freezed,}) {
...
as ContributionCalendar?,stats: freezed == stats ? _self.stats : stats // ignore: cast_nullable_to_non_nullable
as ContributionStats?,fromCache: null == fromCache ? _self.fromCache : fromCache // ignore: cast_nullable_to_non_nullable
...
as CellSize,backgroundPreset: null == backgroundPreset ? _self.backgroundPreset : backgroundPreset // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Username? username,  ContributionCalendar? calendar,  ContributionStats? stats,  bool fromCache,  bool isLoadingCalendar,  Year? year,  bool isLoadingSettings,  Palette? palette,  CellShape cellShape,  CellSize cellSize,  BackgroundPreset backgroundPreset,  Failure? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ViewerState() when $default != null:
return $default(_that.username,_that.calendar,_that.stats,_that.fromCache,_that.isLoadingCalendar,_that.year,_that.isLoadingSettings,_that.palette,_that.cellShape,_that.cellSize,_that.backgroundPreset,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Username? username,  ContributionCalendar? calendar,  ContributionStats? stats,  bool fromCache,  bool isLoadingCalendar,  Year? year,  bool isLoadingSettings,  Palette? palette,  CellShape cellShape,  CellSize cellSize,  BackgroundPreset backgroundPreset,  Failure? error)  $default,) {final _that = this;
switch (_that) {
case _ViewerState():
return $default(_that.username,_that.calendar,_that.stats,_that.fromCache,_that.isLoadingCalendar,_that.year,_that.isLoadingSettings,_that.palette,_that.cellShape,_that.cellSize,_that.backgroundPreset,_that.error);case _:
  throw StateError('Unexpected subclass');
...
class _ViewerState extends ViewerState {
  const _ViewerState({this.username = null, this.calendar = null, this.stats = null, this.fromCache = false, this.isLoadingCalendar = false, this.year, this.isLoadingSettings = false, this.palette, this.cellShape = CellShape.fallback, this.cellSize = CellSize.fallback, this.backgroundPreset = BackgroundPreset.system, this.error = null}): super._();
  

@override@JsonKey() final  Username? username;
@override@JsonKey() final  ContributionCalendar? calendar;
@override@JsonKey() final  ContributionStats? stats;
...
@override@JsonKey() final  BackgroundPreset backgroundPreset;
...
/// Create a copy of ViewerState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? username = freezed,Object? calendar = freezed,Object? stats = freezed,Object? fromCache = null,Object? isLoadingCalendar = null,Object? year = freezed,Object? isLoadingSettings = null,Object? palette = freezed,Object? cellShape = null,Object? cellSize = null,Object? backgroundPreset = null,Object? error = freezed,}) {
